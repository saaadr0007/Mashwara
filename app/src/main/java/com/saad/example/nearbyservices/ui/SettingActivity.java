            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child("image").getValue() != null) {
                    ...
                    if (!image.equals("default"))
                        Picasso.with(SettingActivity.this).load(image).placeholder(R.drawable.man).into(mCircleImageView);
                    //----OFFLINE FEATURE-----
                    final String finalImage = image;
                    Picasso.with(SettingActivity.this).load(image).networkPolicy(NetworkPolicy.OFFLINE).
                            placeholder(R.drawable.man).into(mCircleImageView, new Callback() {
                        @Override
                        ...
                        @Override
                        public void onError() {
                            Picasso.with(SettingActivity.this).load(finalImage).placeholder(R.drawable.man).into(mCircleImageView);
                        }
                    });
                }
            }
